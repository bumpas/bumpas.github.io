(async function () {
  try {
    const { default: PhotoSwipe } = await import('https://cdn.jsdelivr.net/npm/photoswipe@5.4.4/dist/photoswipe.esm.js');
    ...
    await loadCss('https://cdn.jsdelivr.net/npm/photoswipe@5.4.4/dist/photoswipe.css');
